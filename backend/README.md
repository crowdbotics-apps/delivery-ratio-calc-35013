...
## Project Structure
    ...
    ├── delivery_ratio_calc_35013  # Django project configurations
...
1. Clone this repo and `cd delivery_ratio_calc_35013`
...
2. Clone this repo and `cd delivery_ratio_calc_35013`
